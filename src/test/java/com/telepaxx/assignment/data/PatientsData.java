...
public class PatientsData {
    ...
    public final static String PATIENT_NAME = "Lena";
    public final static String API_PATH = "/api/v1/patients/search";
    public final static String MISSING_CRITERIA_MESSAGE = "Provide a least: PatientId or PatientLastName";
    ...
    public final static List<PatientRecord> PATIENTS_RECORDS = List.of(
            new PatientRecord("P2004", "Lena", "Alice", "alice.dcm"),
